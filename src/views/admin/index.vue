<template>
  <div class="app-container">
    ...
    <div style="margin-bottom:20px">
      <el-input v-model="listQuery.search" style="width:250px" placeholder="请输入名称/登录账号" clearable></el-input>
    ...
    <el-table
      ...
      <el-table-column label="登录账号" min-width="90" align="center">
        <template slot-scope="scope">
          {{ scope.row.username }}
        </template>
      </el-table-column>
      <el-table-column label="权限" min-width="110" align="center">
        <template slot-scope="scope">
          <el-tag class="m-r-5" type="success" v-for="role in scope.row.permissions" :key="role.id"> {{role.display_name}} </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" prop="created_at" label="最后登录时间" min-width="110">
        <template slot-scope="scope">
          <i class="el-icon-time"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form ref="form" :rules="rules[dialogStatus]" :model="form" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <!-- <el-form-item label="角色" prop="roles">
          <el-checkbox :indeterminate="isIndeterminateRoles" v-model="checkAllRoles" @change="handleCheckAllRolesChange">全选</el-checkbox>
        ...
        <el-form-item label="权限" prop="permissions">
          <el-checkbox :indeterminate="isIndeterminatePermissions" v-model="checkAllPermissions" @change="handleCheckAllPermissionsChange">全选</el-checkbox>
          <div style="margin: 15px 0;"></div>
          <el-checkbox-group v-model="form.permissions" @change="handleCheckedPermissionsChange">
            <el-checkbox v-for="permission in allPermissions" :label="permission.id" :key="permission.id">{{permission.display_name}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-form>
