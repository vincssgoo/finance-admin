      ...
      <div class="content_bottom">
        ...
        <div class="bottom" v-if="item.type != 1">
          <div class="income_handle" v-if="item.data_before.desc">
            ...
            <span style="margin-left:30px;" v-if="item.data_after.desc">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_after.desc">{{item.data_after.desc}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.price">
            ...
            <span style="margin-left:30px;" v-if="item.data_after.price">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_after.price">{{item.data_after.price}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.pay_datetime || item.data_before.income_datetime">
            ...
            <span style="margin-left:30px;" v-if="item.data_before.pay_datetime || item.data_before.income_datetime">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_before.pay_datetime || item.data_before.income_datetime">{{item.data_before.pay_datetime || item.data_before.income_datetime}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.type">
            ...
            <span style="margin-left:30px;" v-if="item.data_after.type">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_after.type">{{item.data_after.type.title}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.create_user">
            ...
            <span style="margin-left:30px;" v-if="item.data_after.create_user">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_after.create_user">{{item.data_after.create_user}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.content">
            ...
            <span style="margin-left:30px;" v-if="item.data_after.content">变更后：</span>
            <span class="span_width" style="margin-left:20px;" v-if="item.data_after.content">{{item.data_after.content}}</span>
          </div>
          <div class="income_handle" v-if="item.data_before.proof || item.data_before.pay_proof || item.data_before.expense_proof">
            <span style="margin-left:50px;" v-if="item.data_after.proof">修改收入凭证</span>
            <span style="margin-left:50px;" v-if="item.data_after.pay_proof">修改支出凭证</span>
            <span style="margin-left:50px;" v-if="item.data_after.expense_proof">修改报销凭证</span>
          </div>
        </div>
