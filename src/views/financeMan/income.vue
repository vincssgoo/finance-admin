  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading"
      ...
      <el-table-column align="center"
                       ...
                       width="95">
        <template slot-scope="scope">
          <div v-if="scope.row.proof.length!=0">
            已上传
          </div>
          <div v-else
               style="color:red">
        ...
        <template slot-scope="scope"
          ...
          <div>
            <el-button type="warning"
                       @click="goProof(scope.row)">凭证</el-button>
...
export default {
  ...
  methods: {
    ...
    goProof (row) {
      this.$router.replace({ path: '/financeMan/proof', query: { id: row.id } })
    },
