...
export default {
  ...
  methods: {
    ...
    getDetail () {
      ...
      request({
        ...
        this.form = {
          id: this.list.id,
          desc: this.list.desc,
          income_datetime: this.list.income_datetime,
          price: this.list.price,
          type_id: this.list.type_id,
          content: this.list.content,
          proof: this.list.proof,
        }
    ...
    saveData () {
      ...
      if (this.form.income_datetime == null || this.form.income_datetime != this.list.income_datetime) {
